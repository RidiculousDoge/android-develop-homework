...
//                        .setAction("Action", null).show();
    ...
    protected void onStart(){
        ...
        cnt=setinfo.getInt(String.valueOf(cnt),0);
        setTitle("todo "+cnt);
        get_enter_onStart_count(cnt);
    ...
    private void get_enter_onStart_count(int cur){
        SharedPreferences setinfo=getPreferences(Activity.MODE_PRIVATE);
        setinfo.edit().putInt(String.valueOf(cnt),cur+1).commit();
    }
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                String ddl_date=cursor.getString(cursor.getColumnIndex(TodoNote.COLUMN_DDL_DATE));
