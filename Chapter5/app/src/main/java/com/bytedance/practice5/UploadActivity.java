...
public class UploadActivity extends AppCompatActivity {
    ...
    private void initNetwork() {
        ...
        Log.d("sss","created successfully");
    }
    ...
    private void submit() {
        ...
        Log.d("777","before submission");

        Call<UploadResponse> call = api.submitMessage(Constants.STUDENT_ID,"",fromPart,toPart,
                contentPart,coverPart,Constants.token);
        Log.d("888","after submit");
        Log.d("call_desc",call.toString());
